 ...
 *
*/
public class InsertOrder extends SqlUpdate {
	
	public static String SQL_INSERT_ORDER = "";

	public InsertOrder(DataSource dataSource) {
		super(dataSource, SQL_INSERT_ORDER);
		super.declareParameter(new SqlParameter("customer_id", Types.BIGINT));
		super.declareParameter(new SqlParameter("order_date", Types.TIMESTAMP));
